...
describe('UserRepository', () => {
    ...
    describe('findByEmail', () => {
      it('deve chamar findByField com os parâmetros corretos', async () => {
        ...
        // Assert
        expect(mockBaseRepository.findByField).toHaveBeenCalledWith('email', testEmail, {});
      ...
      it('deve passar opções adicionais para findByField', async () => {
        ...
        // Assert
        expect(mockBaseRepository.findByField).toHaveBeenCalledWith('email', testEmail, options);
      });
    });
